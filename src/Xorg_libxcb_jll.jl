...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Xorg_libxcb_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("c7cfdc94-dc32-55de-ac96-5a1b8d977c5b"))
...
if best_platform === nothing
    @debug("Unable to load Xorg_libxcb; unsupported platform $(triplet(platform_key_abi()))")
else
