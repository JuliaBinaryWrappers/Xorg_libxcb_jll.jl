# Autogenerated wrapper script for Xorg_libxcb_jll for x86_64-unknown-freebsd11.1
export libxcb_screensaver, libxcb_xf86dri, libxcb_render, libxcb_xinput, libxcb_shape, libxcb_dri2, libxcb_xv, libxcb_shm, libxcb_damage, libxcb_xvmc, libxcb, libxcb_xinerama, libxcb_xfixes, libxcb_composite, libxcb_xkb, libxcb_dpms, libxcb_randr, libxcb_dri3, libxcb_record, libxcb_glx, libxcb_sync, libxcb_res, libxcb_xtest, libxcb_present
...
"""
function __init__()
    global artifact_dir = abspath(artifact"Xorg_libxcb")
    ...
    foreach(p -> append!(PATH_list, p), (XSLT_jll.PATH_list, Xorg_libXau_jll.PATH_list, Xorg_libXdmcp_jll.PATH_list, Xorg_libpthread_stubs_jll.PATH_list,))
    foreach(p -> append!(LIBPATH_list, p), (XSLT_jll.LIBPATH_list, Xorg_libXau_jll.LIBPATH_list, Xorg_libXdmcp_jll.LIBPATH_list, Xorg_libpthread_stubs_jll.LIBPATH_list,))

    global libxcb_screensaver_path = normpath(joinpath(artifact_dir, libxcb_screensaver_splitpath...))
    ...
    global libxcb_xf86dri_path = normpath(joinpath(artifact_dir, libxcb_xf86dri_splitpath...))
    ...
    global libxcb_render_path = normpath(joinpath(artifact_dir, libxcb_render_splitpath...))
    ...
    global libxcb_xinput_path = normpath(joinpath(artifact_dir, libxcb_xinput_splitpath...))
    ...
    global libxcb_shape_path = normpath(joinpath(artifact_dir, libxcb_shape_splitpath...))
    ...
    global libxcb_dri2_path = normpath(joinpath(artifact_dir, libxcb_dri2_splitpath...))
    ...
    global libxcb_xv_path = normpath(joinpath(artifact_dir, libxcb_xv_splitpath...))
    ...
    global libxcb_shm_path = normpath(joinpath(artifact_dir, libxcb_shm_splitpath...))
    ...
    global libxcb_damage_path = normpath(joinpath(artifact_dir, libxcb_damage_splitpath...))
    ...
    global libxcb_xvmc_path = normpath(joinpath(artifact_dir, libxcb_xvmc_splitpath...))
    ...
    global libxcb_path = normpath(joinpath(artifact_dir, libxcb_splitpath...))
    ...
    global libxcb_xinerama_path = normpath(joinpath(artifact_dir, libxcb_xinerama_splitpath...))
    ...
    global libxcb_xfixes_path = normpath(joinpath(artifact_dir, libxcb_xfixes_splitpath...))
    ...
    global libxcb_composite_path = normpath(joinpath(artifact_dir, libxcb_composite_splitpath...))
    ...
    global libxcb_xkb_path = normpath(joinpath(artifact_dir, libxcb_xkb_splitpath...))
    ...
    global libxcb_dpms_path = normpath(joinpath(artifact_dir, libxcb_dpms_splitpath...))
    ...
    global libxcb_randr_path = normpath(joinpath(artifact_dir, libxcb_randr_splitpath...))
    ...
    global libxcb_dri3_path = normpath(joinpath(artifact_dir, libxcb_dri3_splitpath...))
    ...
    global libxcb_record_path = normpath(joinpath(artifact_dir, libxcb_record_splitpath...))
    ...
    global libxcb_glx_path = normpath(joinpath(artifact_dir, libxcb_glx_splitpath...))
    ...
    global libxcb_sync_path = normpath(joinpath(artifact_dir, libxcb_sync_splitpath...))
    ...
    global libxcb_res_path = normpath(joinpath(artifact_dir, libxcb_res_splitpath...))
    ...
    global libxcb_xtest_path = normpath(joinpath(artifact_dir, libxcb_xtest_splitpath...))
    ...
    global libxcb_present_path = normpath(joinpath(artifact_dir, libxcb_present_splitpath...))
